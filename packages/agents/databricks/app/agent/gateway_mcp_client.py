"""
Gateway MCP Client for connecting to AgentCore Gateway.
...
def get_gateway_mcp_client() -> MCPClient:
    ...
    Only loads tools matching the databricks_* pattern from the gateway.
    """
    ...
    return MCPClient(
        ...
        tool_filters={"allowed": [re.compile(r"^databricks-target___")]},
    )
